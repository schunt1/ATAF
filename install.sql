...
PROMPT 'Import Data'
--------------------
@ATAF_DATA/ATAF_ACTION
@ATAF_DATA/ATAF_SELENIUM
@ATAF_DATA/ATAF_TEST_DATA
@ATAF_DATA/ATAF_DATA_ITEM
@ATAF_DATA/ATAF_DATA

PROMPT 'Import Test Data'
-------------------------
@ATAF_DATA/ATAF_PROJECT
@ATAF_DATA/ATAF_TEST_SPEC
@ATAF_DATA/ATAF_TEST_CASE
@ATAF_DATA/ATAF_TEST_COND
@ATAF_DATA/ATAF_SPEC_CASE
