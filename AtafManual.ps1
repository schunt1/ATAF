...
foreach($obj in $specObject.items)
{
 ...
 java -jar C:\Selenium\Server\selenium-server-standalone-2.53.1.jar -htmlSuite "*firefox C:\Program Files (x86)\Mozilla Firefox\firefox.exe" "https://ci.westminster.mod.uk/app/" $specFileName $resultFileName
}