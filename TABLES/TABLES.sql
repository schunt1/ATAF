...
CREATE TABLE  "ATAF_PROJECT" 
   (	"PROJECT_ID" NUMBER, 
	...
	"OWNER" VARCHAR2(32), 
	"TL_USERNAME" VARCHAR2(64), 
	"TL_PASSWORD" VARCHAR2(64),
...
ALTER TABLE  "ATAF_SPEC_CASE" ADD CONSTRAINT "ATAF_SPEC_CASE_FK1" FOREIGN KEY ("DATA_GROUP_ID")
	  REFERENCES  "ATAF_DATA_GROUPS" ("DATA_GROUP_ID") ENABLE
/
ALTER TABLE  "ATAF_SPEC_CASE" ADD CONSTRAINT "ATAF_SPEC_CASE_FK3" FOREIGN KEY ("SPEC_CASE_REF_ID")
	  REFERENCES  "ATAF_SPEC_CASE" ("SPEC_CASE_ID") ON DELETE CASCADE ENABLE
/
