...
INSERT INTO ataf_selenium (selenium_id, selenium_command, action_id, data_yn, location, target, item_attribute, row_key, sort_order, row_version_number, theme_number) VALUES (57605729023682593998986985955943046915, q'!type!', 23858542572669700969330700059483863540, 'Y', 'id', q'!#DOM_ID#_search_field!', '', 'AIDT', 0, 2, 42);
INSERT INTO ataf_selenium (selenium_id, selenium_command, action_id, data_yn, location, target, item_attribute, row_key, sort_order, row_version_number, theme_number) VALUES (57605729023683802924806600585117753091, q'!click!', 23858542572669700969330700059483863540, 'N', 'id', q'!#DOM_ID#_search_button!', '', 'AIDU', 2, 2, 42);
